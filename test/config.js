// Endpoints
const MAGE_ENDPOINT_KVTOOL = "http://localhost:1317";
const BINANCE_CHAIN_ENDPOINT_KVTOOL = "http://localhost:8080";

// Mnemonics
const LOADED_MAGE_MNEMONIC = "arrive guide way exit polar print kitchen hair series custom siege afraid shrug crew fashion mind script divorce pattern trust project regular robust safe";
...
const BEP3_ASSETS = {
  "bnb": {
    ...
    mageDeputyHotWallet: "mage1agcvt07tcw0tglu0hmwdecsnuxp2yd45f3avgm",
  ...
  "btcb": {
    ...
    mageDeputyHotWallet: "mage1kla4wl0ccv7u85cemvs3y987hqk0afcv7vue84",
  ...
  "xrpb": {
    ...
    mageDeputyHotWallet: "mage14q5sawxdxtpap5x5sgzj7v4sp3ucncjlpuk3hs",
  ...
  "busd": {
    ...
    mageDeputyHotWallet: "mage1j9je7f6s0v6k7dmgv6u5k5ru202f5ffsc7af04",
...
module.exports = {
  MAGE_ENDPOINT_KVTOOL,
  BINANCE_CHAIN_ENDPOINT_KVTOOL,
  LOADED_MAGE_MNEMONIC,
