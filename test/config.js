// Endpoints
const KAVA_ENDPOINT_MGTOOL = "http://localhost:1317";
const BINANCE_CHAIN_ENDPOINT_MGTOOL = "http://localhost:8080";
...
module.exports = {
  KAVA_ENDPOINT_MGTOOL,
  BINANCE_CHAIN_ENDPOINT_MGTOOL,
